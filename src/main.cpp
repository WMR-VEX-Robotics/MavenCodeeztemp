...
ez::tracking_wheel horiz_tracker(16, 2.75, -7);  // This tracking wheel is perpendicular to the drive wheels
ez::tracking_wheel vert_tracker(-14, 2.75, -0.375);   // This tracking wheel is parallel to the drive wheels
...
void autonomous() {
  ...
  chassis.odom_xyt_set(0_in, 0_in, 68_deg);    // Set the current position, you can start at a specific position with this
