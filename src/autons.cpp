...
void redLeft() {
  ...
  chassis.pid_odom_set({{-8.5, 15.5, -7}, fwd, 80});
  chassis.pid_wait_quick();
  chassis.pid_odom_set({{-9.5, 35.7, -16}, fwd, 55});
  pros::delay(1050);
  loader.set(true); // extend pusher
  chassis.pid_turn_set(-80, 100);
  chassis.pid_odom_set({{-20, 0, -160}, fwd, 70}); // added exit conditions
  chassis.pid_odom_set({{-33.2 -15, 179.5}, fwd, 70});
  pros::delay(3900);
  chassis.pid_odom_set({{-34, 0, 180}, rev, 127});
  pros::delay(1000);
  intakebottom.move(-127);
  pros::delay(300);
  intakebottom.move(127);
  loader.set(false);
  chassis.pid_odom_set({{-33.75, 10, 0}, fwd, 127});
  pros::delay(1000);
  chassis.pid_odom_set({{-33, 13, 0}, fwd, 127});
  chassis.pid_wait_quick();
  pros::delay(100);
  lift.move(127);
  pros::delay(1000);
  chassis.pid_odom_set({{-34.55, 21, 0}, fwd, 127});
  pros::delay(300);
  intakebottom.move(-127);
}
...
void redRight() {
  ...
  chassis.pid_wait_quick();
  chassis.pid_odom_set({{9.75, 35.7, 16}, fwd, 55});
  pros::delay(1050);
  loader.set(true); // extend pusher
  chassis.pid_turn_set(80, 100);
  chassis.pid_odom_set({{20, 0, 160}, fwd, 70}); // added exit conditions
  ...
  int i = 0;
  while(i<2) {
    chassis.pid_odom_set({{33.3, -16, 180}, fwd, 70});
    pros::delay(750);
    chassis.pid_odom_set({{33.8, -17, 180}, fwd, 70});
    i++;
  }
  pros::delay(600);
...
void blueLeft() {
  ...
  chassis.pid_turn_set(-80, 100);
  chassis.pid_odom_set({{-20, 0, -160}, fwd, 70}); // added exit conditions
  chassis.pid_odom_set({{-35, -15, 180.5}, fwd, 70});
  pros::delay(5000);
...
void rightNewTest() {
  //chassis.pid_odom_set({{0, 3, 0}, fwd, 30});
  intakebottom.move(127); // start intake
  chassis.pid_odom_set({{0.75, 4, 7}, fwd, 80});
  chassis.pid_wait_quick();
  chassis.pid_odom_set({{9.75, 35.7, 18}, fwd, 35});
  chassis.pid_wait_quick();
  chassis.pid_drive_set(-10, 127);
  chassis.pid_wait_quick();
  chassis.pid_odom_set({{-3.5, 33.2, -46}, fwd, 100});
  chassis.pid_wait_quick();
  intakebottom.move(-77);
  pros::delay(850);
  intakebottom.move(0);
  chassis.pid_drive_set(-10, 127);
  chassis.pid_wait_quick();
  ...
  intakebottom.move(127);
  loader.set(true);
  chassis.pid_odom_set({{29.5, -22, -180}, fwd, 90});
  chassis.pid_wait();
  pros::delay(200);
  chassis.pid_odom_set({{28.5, 0, -180}, rev, 127});
  chassis.pid_wait_quick();
  chassis.pid_turn_set(0, 127);
  intakebottom.move(127);
  loader.set(false);
  //chassis.pid_odom_set({{33, 9, 0}, fwd, 127});
  chassis.pid_wait_quick();
  //pros::delay(100);
  lift.move(127);
  pros::delay(1100);
  chassis.pid_odom_set({{30, 25, 0}, fwd, 127});
  pros::delay(700);
  intakebottom.move(-127);
...
void leftNewTest() {
  ...
  pros::delay(500);
  lift.move(10);
  chassis.pid_odom_set({{3.5, 36, 45}, fwd, 100});
  chassis.pid_wait_quick();
  intakebottom.move(-77);
  pros::delay(850);
  intakebottom.move(0);
  ...
  intakebottom.move(127);
  loader.set(true);
  chassis.pid_odom_set({{-34.25, -23, 180}, fwd, 90});
  chassis.pid_wait();
  pros::delay(200);
  chassis.pid_odom_set({{-34.25, 0, 180}, rev, 127});
  chassis.pid_wait_quick();
  chassis.pid_turn_set(0, 127);
  intakebottom.move(127);
  loader.set(false);
  ...
  lift.move(127);
  pros::delay(1100);
  chassis.pid_odom_set({{-33.5, 25, 0}, fwd, 127});
  pros::delay(700);
  intakebottom.move(-127);
}
