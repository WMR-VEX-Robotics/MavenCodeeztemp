...
void rightNewTest() {
  ...
  chassis.pid_wait_quick();
  chassis.pid_odom_set({{-5.25, 35, -45}, fwd, 100});
  chassis.pid_wait_quick();
  ...
  intakebottom.move(127);
  loader.set(true);
  chassis.pid_odom_set({{33, -17, -180}, fwd, 70});
  chassis.pid_wait();
  pros::delay(200);
  chassis.pid_odom_set({{32, 4, -180}, rev, 127});
  chassis.pid_wait_quick();
  chassis.pid_turn_set(0, 127);
  intakebottom.move(127);
  loader.set(false);
  chassis.pid_odom_set({{34, 9, 0}, fwd, 127});
  chassis.pid_wait_quick();
  pros::delay(100);
  lift.move(127);
  pros::delay(1100);
  chassis.pid_odom_set({{34, 24, 0}, fwd, 127});
  pros::delay(700);
  intakebottom.move(-127);
